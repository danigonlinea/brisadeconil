...
export const t: Record<string, Record<Locale, string>> = {
  ...
  // ── Nav ───────────────────────────────────────────────────────────────────
  'nav.link.apartamento': { es: 'El apartamento', en: 'The apartment', de: 'Die Wohnung' },
  ...
  'nav.cta':              { es: 'Reservar fechas', en: 'Book your dates', de: 'Daten buchen' },
  'nav.toggle-dark':      { es: 'Activar modo oscuro',  en: 'Enable dark mode',  de: 'Dunkelmodus aktivieren' },
  'nav.toggle-light':     { es: 'Activar modo claro',   en: 'Enable light mode', de: 'Hellmodus aktivieren' },

  // ── Hero ──────────────────────────────────────────────────────────────────
  'hero.tagline':   {
    es: 'Tu rincón en la Costa de la Luz',
  ...
  'hero.headline-2': {
    es: 'brisa de Atlántico',
    en: 'an Atlantic breeze',
    de: 'atlantischer Brise',
  },
  'hero.subline': {
    es: 'Apartamento en el centro de Conil de la Frontera. A pasos del mercado, a minutos del mar.',
    en: 'Apartment in the centre of Conil de la Frontera. Steps from the market, minutes from the sea.',
    de: 'Wohnung im Zentrum von Conil de la Frontera. Gleich neben dem Markt, Minuten vom Meer.',
  },
  'hero.cta': {
  ...
  // ── Gallery ───────────────────────────────────────────────────────────────
  'gallery.label':    { es: 'Galería de fotos',  en: 'Photo gallery',       de: 'Fotogalerie' },
  'gallery.title':    { es: 'El apartamento',    en: 'The apartment',        de: 'Die Wohnung' },
  'gallery.lead':     {
  ...
  'apt.lead':    {
    es: 'Un espacio pensado para descansar de verdad. Cómodo, bien equipado y en el mejor sitio de Conil.',
  ...
  'apt.spec.capacity.label': { es: 'Capacidad',     en: 'Capacity',      de: 'Kapazität' },
  'apt.spec.capacity.value': { es: '3 personas',    en: '3 guests',      de: '3 Personen' },
  'apt.spec.bed.label':      { es: 'Dormitorio',    en: 'Bedroom',       de: 'Schlafzimmer' },
  'apt.spec.bed.value':      { es: '1 habitación + sofá cama', en: '1 bedroom + sofa bed', de: '1 Schlafzimmer + Schlafsofa' },
  'apt.spec.bath.label':     { es: 'Baño',          en: 'Bathroom',      de: 'Badezimmer' },
  'apt.spec.bath.value':     { es: 'Ducha independiente', en: 'Walk-in shower', de: 'Dusche' },
  'apt.spec.layout.label':   { es: 'Distribución',  en: 'Layout',        de: 'Aufteilung' },
  'apt.spec.layout.value':   { es: 'Salón-cocina integrado', en: 'Open-plan living & kitchen', de: 'Offene Wohnküche' },
  'apt.spec.access.label':   { es: 'Acceso',        en: 'Access',        de: 'Zugang' },
  'apt.spec.access.value':   { es: 'Planta baja, sin escaleras', en: 'Ground floor, no stairs', de: 'Erdgeschoss, keine Treppen' },
  'apt.access-note':         {
    es: 'El apartamento está en planta baja con acceso directo desde la calle. Llegas, apartas la maleta y ya estás de vacaciones.',
  ...
  'amenities.title': { es: 'Todo lo que necesitas', en: 'Everything you need',   de: 'Alles was du brauchst' },
  'amenities.lead':  {
    es: 'Electrodomésticos, climatización y conexión para que solo tengas que pensar en disfrutar.',
  ...
  'amenities.item.ac':          { es: 'Aire acondicionado',  en: 'Air conditioning',   de: 'Klimaanlage' },
  'amenities.item.ac.detail':   { es: 'En el dormitorio',    en: 'In the bedroom',      de: 'Im Schlafzimmer' },
  'amenities.item.fan':         { es: 'Ventilador de techo', en: 'Ceiling fan',         de: 'Deckenventilator' },
  'amenities.item.fan.detail':  { es: 'En el dormitorio',    en: 'In the bedroom',      de: 'Im Schlafzimmer' },
  'amenities.item.wifi':        { es: 'Fibra óptica',        en: 'Fibre broadband',     de: 'Glasfaser-Internet' },
  'amenities.item.wifi.detail': { es: 'En todo el apartamento', en: 'Throughout the apartment', de: 'In der gesamten Wohnung' },
  'amenities.item.tv':          { es: 'Televisión',          en: 'Television',          de: 'Fernseher' },
  'amenities.item.tv.detail':   { es: '60 pulgadas',         en: '60 inches',           de: '60 Zoll' },
  'amenities.item.fridge':      { es: 'Frigorífico',         en: 'Fridge',              de: 'Kühlschrank' },
  'amenities.item.fridge.detail':{ es: 'Completo',           en: 'Full-size',           de: 'Vollständig' },
  'amenities.item.washer':      { es: 'Lavadora',            en: 'Washing machine',     de: 'Waschmaschine' },
  'amenities.item.washer.detail':{ es: '',                   en: '',                    de: '' },
  'amenities.item.dishwasher':  { es: 'Lavavajillas',        en: 'Dishwasher',          de: 'Geschirrspüler' },
  'amenities.item.dishwasher.detail':{ es: '',               en: '',                    de: '' },
  'amenities.item.microwave':   { es: 'Microondas',          en: 'Microwave',           de: 'Mikrowelle' },
  'amenities.item.microwave.detail':{ es: '',                en: '',                    de: '' },

  // ── Welcome ───────────────────────────────────────────────────────────────
  'welcome.label': { es: 'Desde el primer día',  en: 'From day one',        de: 'Von Anfang an' },
  'welcome.title': {
  ...
  'welcome.item.towels':          { es: 'Toallas y sábanas',         en: 'Towels & bed linen',       de: 'Handtücher & Bettwäsche' },
  'welcome.item.towels.detail':   { es: 'Incluidas y limpias',       en: 'Included and freshly laundered', de: 'Inklusive und frisch gewaschen' },
  'welcome.item.detergent':       { es: 'Detergente y suavizante',   en: 'Detergent & softener',     de: 'Waschmittel & Weichspüler' },
  'welcome.item.detergent.detail':{ es: 'Para tu primera lavada',    en: 'For your first wash',      de: 'Für die erste Wäsche' },
  'welcome.item.hairdryer':       { es: 'Secador de pelo',           en: 'Hair dryer',               de: 'Haartrockner' },
  'welcome.item.hairdryer.detail':{ es: '',                          en: '',                         de: '' },
  'welcome.item.kitchen':         { es: 'Básicos de cocina',         en: 'Kitchen basics',           de: 'Küchengrundausstattung' },
  'welcome.item.kitchen.detail':  { es: 'Aceite, vinagre y servilletas', en: 'Oil, vinegar and napkins', de: 'Öl, Essig und Servietten' },
  'welcome.closing': {
  ...
  // ── Location ──────────────────────────────────────────────────────────────
  'location.label':   { es: 'Dónde estamos',         en: 'Where we are',       de: 'Wo wir sind' },
  'location.title':   { es: 'En el corazón de Conil', en: 'In the heart of Conil', de: 'Im Herzen von Conil' },
  'location.lead':    {
  ...
  'location.parking.mercado.name':   { es: 'Mercado de Abastos', en: 'Mercado de Abastos', de: 'Mercado de Abastos' },
  ...
  'location.parking.ora.name':   { es: 'Zona Azul (ORA)',  en: 'Blue Zone (ORA)',  de: 'Blaue Zone (ORA)' },
  ...
  'location.parking.ferial.name':   { es: 'Recinto Ferial', en: 'Recinto Ferial', de: 'Recinto Ferial' },
  ...
  'location.parking.free-badge':  { es: 'Gratuito', en: 'Free',    de: 'Kostenlos' },
  'location.parking.paid-badge':  { es: 'De pago',  en: 'Paid',    de: 'Kostenpflichtig' },
  ...
  // ── Conil ─────────────────────────────────────────────────────────────────
  'conil.label': { es: 'Qué hacer',       en: 'Things to do',      de: 'Freizeitangebote' },
  'conil.title': { es: 'Conil te espera', en: 'Conil is waiting',  de: 'Conil wartet auf dich' },
  'conil.lead':  {
  ...
  'conil.oldtown.title': { es: 'Casco histórico', en: 'Old town',  de: 'Altstadt' },
  'conil.food.title':    { es: 'Gastronomía',     en: 'Gastronomy', de: 'Gastronomie' },
  'conil.disclaimer':    {
  ...
  // ── Rules ─────────────────────────────────────────────────────────────────
  'rules.label':          { es: 'Normas de la casa', en: 'House rules',  de: 'Hausregeln' },
  'rules.title':          {
  ...
  'rules.deposit.label':  { es: 'Fianza',            en: 'Security deposit', de: 'Kaution' },
  ...
  'contact.title':   { es: '¿Cuándo te vienes?', en: 'When are you coming?', de: 'Wann kommst du?' },
  'contact.lead':    {
  ...
  'faq.title': { es: 'Lo que nos suelen preguntar', en: 'Questions we get asked', de: 'Was uns oft gefragt wird' },

  // ── Testimonials ──────────────────────────────────────────────────────────
  'testimonials.label': { es: 'Opiniones',                    en: 'Reviews',                    de: 'Bewertungen' },
  'testimonials.title': { es: 'Lo que dicen nuestros huéspedes', en: 'What our guests say',     de: 'Was unsere Gäste sagen' },
  'testimonials.note':  {
  ...
  'footer.legal-link':{ es: 'Aviso legal', en: 'Legal notice', de: 'Impressum' },
  'footer.link.apartamento': { es: 'El apartamento', en: 'The apartment', de: 'Die Wohnung' },
