...
export const apartment = {
  ...
  specs: [
    ...
    { icon: 'bed',     label: 'Schlafzimmer', value: '1 Schlafzimmer + Schlafsofa' },
...
export const amenities = {
  ...
  items: [
    ...
    { icon: 'wifi',        label: 'Glasfaser-Internet',  detail: 'In der gesamten Wohnung' },
...
export const welcome = {
  ...
  lead: 'Kein Stopp im Supermarkt nötig. Das Wichtigste wartet schon auf dich.',
  items: [
    { icon: 'towel',    label: 'Handtücher & Bettwäsche', detail: 'Inklusive und frisch gewaschen' },
    { icon: 'droplets', label: 'Waschmittel & Weichspüler', detail: 'Für die erste Wäsche' },
    { icon: 'wind',     label: 'Haartrockner',             detail: '' },
    { icon: 'flask',    label: 'Küchengrundausstattung',   detail: 'Öl, Essig und Servietten' },
  ],
  closing: 'Bring nur die Lust auf Erholung mit.',
};
...
export const location = {
  ...
  parking: {
    headline: 'Parken',
    options: [
      { name: 'Mercado de Abastos', detail: 'Städtischer Parkplatz direkt gegenüber. Die praktischste Option.', type: 'paid' },
      { name: 'Blaue Zone (ORA)',   detail: 'In der Hochsaison kostenpflichtig. Schilder beachten.', type: 'paid' },
      { name: 'Recinto Ferial',     detail: 'Großer kostenloser Parkplatz in der Nähe. Empfohlen im Juli und August.', type: 'free' },
    ],
    seasonNote:
...
export const rules = {
  ...
  deposit: {
    label: 'Kaution',
    amount: '150 €',
    return: 'Wird 24–48 Stunden nach dem Auszug zurückgezahlt, sobald alles geprüft wurde.',
  },
  rules: [
    { icon: 'trash',         text: 'Müll vor dem Abreisen rausbringen.' },
    { icon: 'clock',         text: 'Check-in und Check-out Zeiten: [AUSSTEHEND — Eigentümer bestätigt].' },
    { icon: 'paw',           text: 'Haustierrichtlinie: [AUSSTEHEND — Eigentümer bestätigt].' },
    { icon: 'cigarette-off', text: 'Rauchrichtlinie: [AUSSTEHEND — Eigentümer bestätigt].' },
    { icon: 'volume-x',      text: 'Bitte Nachtruhe der Nachbarn respektieren.' },
  ],
  placeholderNote: 'Felder mit [AUSSTEHEND] werden vor der Veröffentlichung aktualisiert.',
};
...
export const contact = {
  ...
  fields: {
    ...
    message: { label: 'Nachricht (optional)', placeholder: 'Hast du Fragen oder besondere Wünsche?' },
  },
  submit: 'Anfrage senden',
  sending: 'Wird gesendet…',
  successHeadline: 'Nachricht gesendet!',
  successMessage: 'Danke für deine Anfrage. Wir melden uns so schnell wie möglich.',
...
export const faq = {
  ...
  items: [
    { q: 'Wie sind die Check-in und Check-out Zeiten?', a: '[AUSSTEHEND — Eigentümer bestätigt.]', pending: true },
    { q: 'Sind Haustiere erlaubt?',                     a: '[AUSSTEHEND — Eigentümer bestätigt.]', pending: true },
    { q: 'Ist Rauchen erlaubt?',                        a: '[AUSSTEHEND — Eigentümer bestätigt.]', pending: true },
    { q: 'Wie sind die Stornierungsbedingungen?',       a: '[AUSSTEHEND — Eigentümer bestätigt.]', pending: true },
    { q: 'Was wenn ich später ankomme?',                a: '[AUSSTEHEND — wir informieren dich in deiner Buchungsbestätigung.]', pending: true },
    { q: 'Wie viele Personen können übernachten?', a: 'Die Wohnung schläft 3: 2 im Doppelbett und 1 auf dem Schlafsofa im Wohnzimmer.', pending: false },
    { q: 'Gibt es Parkmöglichkeiten in der Nähe?', a: 'Ja. Der Mercado de Abastos direkt gegenüber hat städtisches Parken. In der Hochsaison empfehlen wir das Recinto Ferial (kostenlos).', pending: false },
    { q: 'Wie wird die Kaution gehandhabt?', a: 'Die Kaution beträgt 150 € und wird 24–48 Stunden nach dem Auszug zurückgezahlt.', pending: false },
    { q: 'Muss ich Handtücher mitbringen?', a: 'Nein. Handtücher und Bettwäsche sind inklusive. Du findest auch Waschmittel, Weichspüler, Haartrockner und Küchengrundausstattung.', pending: false },
  ],
};
...
export const testimonials = {
  ...
  placeholder: true,
  items: [
    { name: 'María G.', origin: 'Madrid',       rating: 5, text: '[PLATZHALTER — echte Bewertung ausstehend]' },
    { name: 'Thomas K.',origin: 'Deutschland',  rating: 5, text: '[PLATZHALTER — echte Bewertung ausstehend]' },
    { name: 'Sophie L.',origin: 'Frankreich',   rating: 5, text: '[PLATZHALTER — echte Bewertung ausstehend]' },
  ],
};
