...
export const hero = {
  ...
  subline: 'The apartment is on Calle Rosa de los Vientos, opposite the Mercado de Abastos (Market Hall) and minutes from the beach.',
...
export const faq = {
  ...
  items: [
    ...
    { q: 'How does self check-in work?', a: "If you arrive outside check-in hours or prefer not to coordinate, you can do a self check-in using the key box. We'll send you the code before your arrival.", pending: false },
    { q: 'Is there heating for winter?', a: 'Yes. The apartment has independent heating so you stay comfortable in the colder months too.', pending: false },
    { q: 'Is a cot available?', a: 'Yes, on request. Let us know before your arrival so we can have it ready.', pending: false },
    { q: 'Is the apartment accessible for people with reduced mobility?', a: 'The apartment is on the first floor and is reached only by stairs (no lift). It is not suitable for wheelchairs.', pending: false },
