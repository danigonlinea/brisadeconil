...
3. **Secretos fuera del cliente.** El formulario postea a Web3Forms directamente (eliminada la API server-side `/api/contact`). `PUBLIC_WEB3FORMS_KEY` es la única key permitida en cliente. Nunca commitees `.env`.
